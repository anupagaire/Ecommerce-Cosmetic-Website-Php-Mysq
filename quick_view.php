...
<section class="quick-view">
   ...
   <form action="" method="post" class="box">
      ...
      if ($fetch_product['quantity'] <= 0) {
         echo '<input type="submit" value="add to wishlist" class="btn" name="add_to_wishlist" >';
                  }
         else{
            echo '<input type="submit" value="add to wishlist" class="btn" name="add_to_wishlist"  style="background-color: #121212; cursor:not-allowed;" disabled  >';
         }
      ?>
            </div>
         </div>
